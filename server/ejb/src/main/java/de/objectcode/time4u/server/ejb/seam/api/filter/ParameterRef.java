...
public class ParameterRef implements IFilter
{
  ...
  public String getWhereClause(final EntityType entityType, final Map<String, BaseParameterValue> parameters, ELContext context)
  {
    ...
    return parameterValue.getFilter().getWhereClause(entityType, parameters, context);
  }
      ...
      final Map<String, BaseParameterValue> parameters, ELContext context)
  {
    ...
    parameterValue.getFilter().setQueryParameters(entityType, query, parameters, context);
  }
