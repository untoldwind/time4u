...
public abstract class BaseMigratorPart<T> implements IMigratorPart
{
      ...
      final SessionFactory newSessionFactory)
  {
    ...
    try {
      ...
      while (results.next()) {
        ...
        migrateEntity(oldSession, newSession, oldEntity, revisionLock.getLatestRevision());
  ...
  protected abstract void migrateEntity(Session oldSession, Session newSession, T oldEntity, long newRevision);
}
