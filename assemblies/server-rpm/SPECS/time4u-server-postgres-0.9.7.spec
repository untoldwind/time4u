...
sed "s/@db.user@/time4u/ ; s/@db.name@/time4u/ ; s/@db.password@/time4u/ ; s/@db.host@/localhost/" $RPM_BUILD_DIR/time4u-assemblies-deploy-%{version}/db/postgres/time4u-ds.xml > /srv/time4u-with-jboss/server/time4u/deploy/time4u-ds.xml
chown wwwrun:www /srv/time4u-with-jboss/server/time4u/deploy/time4u-ds.xml
mv $RPM_BUILD_DIR/time4u-assemblies-deploy-%{version}/db/postgres/time4u-hibernate.cfg.xml /srv/time4u-with-jboss/server/time4u/conf
cp $RPM_SOURCE_DIR/time4u-postgres-init.sql /srv/time4u-with-jboss
chown wwwrun:www /srv/time4u-with-jboss/time4u-postgres-init.sql
mkdir -p /srv/time4u-with-jboss/server/time4u/deploy/messaging
sed "s/DefaultDS/Time4UDS/ ; 149d" $RPM_BUILD_DIR/time4u-with-jboss/docs/examples/jms/postgresql-persistence-service.xml > /srv/time4u-with-jboss/server/time4u/deploy/messaging/postgresql-persistence-service.xml
chown wwwrun:www /srv/time4u-with-jboss/server/time4u/deploy/messaging/postgresql-persistence-service.xml
